...
namespace TwinSkinLondon.Controllers
{
    ...
    public class PaymentCardsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PaymentCardID,CardName,CardNumber,ExpiryMonth,ExpiryYear,CVV")] PaymentCard paymentCard)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PaymentCardID,CardName,CardNumber,ExpiryMonth,ExpiryYear,CVV")] PaymentCard paymentCard)
        {
