...
namespace TwinSkinLondon.Controllers
{
    public class OrderItemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderItemID,OrderID,ProductID,Price,Quantity")] OrderItem orderItem)
        {
            ...
            ViewData["ProductID"] = new SelectList(_context.Set<Product>(), "ProductID", "Name", orderItem.ProductID);
            return View(orderItem);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderItemID,OrderID,ProductID,Price,Quantity")] OrderItem orderItem)
        {
